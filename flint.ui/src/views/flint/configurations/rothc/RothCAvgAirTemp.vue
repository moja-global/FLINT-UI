      ...
      <div>
        ...
        <div class="flex flex-wrap mt-10">
          <div class="w-full px-4 content-center rounded-md m-12 mb-5">
            <h1 class="flex-auto text-xl font-semibold">avgAirTemp - data_orig</h1>
            <textarea
          ...
          <div class="w-full px-4 content-center rounded-md m-12 mb-5">
            <h1 class="flex-auto text-xl font-semibold">avgAirTemp - data_month_avg</h1>
            <textarea
          ...
          <div class="w-full px-4 content-center rounded-md m-12 mb-5">
            <h1 class="flex-auto text-xl font-semibold">avgAirTemp - data_lastyearcopy</h1>
            <textarea
