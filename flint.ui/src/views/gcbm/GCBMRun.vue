...
export default {
  ...
  methods: {
    runSim: function () {
      ...
      axios
        .post('process.env.VUE_APP_ROOT_URL/gcbm/dynamic', bodyFormData)
        .then((response) => {
    ...
    checkStatus: function () {
      ...
      axios
        .post('process.env.VUE_APP_ROOT_URL/gcbm/status', bodyFormData)
        .then((response) => {
    ...
    downloadSim: function () {
      ...
      axios
        .post('process.env.VUE_APP_ROOT_URL/gcbm/download', bodyFormData, {
