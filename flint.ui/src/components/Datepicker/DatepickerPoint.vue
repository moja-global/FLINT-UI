    ...
    <div>
        <div class="flex w-full">
            <div class="w-12/12 md:w-10/12">
                ...
                <div :style="styles()">
                    <DatePickerComponent @changeDate="onStartChange"
                                         startYear="1924"
                                         endYear="2022"
                ...
                <div class="w-12/12 md:w-10/12">
                    ...
                    <div :style="styles()">
                        <DatePickerComponent @changeDate="onEndChange"
                                             startYear="1924"
                                             endYear="2022"
                                             placeholder="Select the date" />
                    </div>
        ...
        <h3 class="mt-14 py-4 text-xl font-medium mb-2 text-gray-600 justify-center">
            ...
            <span class="text-persiangreen">{{ date_diff >= 0.00 ? date_diff.toFixed(2) + ' years' : 'invalid' }}</span>
        </h3>
    </div>
</template>
<script>
